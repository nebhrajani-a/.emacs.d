...
(defvar evil-mc-key-map
  (let ((map (make-sparse-keymap)))
    (evil-define-key* '(normal visual) map
                      ...
                      (kbd "M-n") 'evil-mc-resume-cursors
                      (kbd "M-p") 'evil-mc-pause-cursors
                      (kbd "C-n") 'evil-mc-make-cursor-here
                      (kbd "C-p") 'evil-mc-make-cursor-here
                      (kbd "C-t") 'evil-mc-undo-last-added-cursor
                      (kbd "C-y") 'evil-mc-undo-all-cursors)
    map))
